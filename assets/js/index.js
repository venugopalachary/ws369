...
const f = "float PI = 3.141592653589793238;",
    ...
    R = (e, t) => {
        ...
        if (Array.isArray(e) && e.length) {
            ...
            s = {}, Object.keys(G).forEach((t => {
                e.includes(t) && (s[t] = G[t])
            }))
        }
        const r = Math.floor(Math.random() * Object.keys(s).length);
        return s[Object.keys(s)[r]]
    };
class K {
    constructor(e) {
    ...
    animateUniform(e, t, n) {
        ...
        const r = t > e.value ? "next" : "prev",
            a = (e, t) => "next" === r && e >= t || "prev" === r && e <= t,
            l = () => {
    ...
    resize() {
        ...
        let i, s;
        t / e > o ? (i = e / t * o, s = 1) : (i = 1, s = t / e / o), this.material.uniforms.resolution.value.x = e, this.material.uniforms.resolution.value.y = t, this.material.uniforms.resolution.value.z = i, this.material.uniforms.resolution.value.w = s, this.shader.vertex && this.vertexMaterial && (this.vertexMaterial.uniforms.resolution.value.x = e, this.vertexMaterial.uniforms.resolution.value.y = t, this.vertexMaterial.uniforms.resolution.value.z = i, this.vertexMaterial.uniforms.resolution.value.w = s), this.shader.vertex ? (this.nextMesh.scale.set(this.camera.aspect / 2, .5, .5), this.currentMesh.scale.set(this.camera.aspect / 2, .5, .5)) : (this.plane.scale.x = this.camera.aspect, this.plane.scale.y = 1)
    }
    createMaterial() {
        return new h(this.gl, ((e, s) => {
            for (var r in s || (s = {})) n.call(s, r) && i(e, r, s[r]);
            if (t)
                for (var r of t(s)) o.call(s, r) && i(e, r, s[r]);
            return e
        })({
            extensions: {
            ...
            const e = function(e, t, n) {
                    ...
                    for (let r = 0; r < a; r += 1) {
                        ...
                        for (let e = 0; e <= o; e += 1) {
                            ...
                            c.push(e * i + d - 1, v - 1, 0), x.push((e * i + d) / 2, v / 2), c.push(e * i + i / 2 + d - 1, s + v - 1, 0), x.push((e * i + i / 2 + d) / 2, (s + v) / 2), c.push(e * i - i / 2 + d - 1, s + v - 1, 0), x.push((e * i - i / 2 + d) / 2, (s + v) / 2);
                            ...
                            h.push(...G, ...G, ...G), p.push(...C, ...C, ...C), u.push(0, 0, 1, 0, 1, 0, 1, 0, 0), c.push(e * i + d - 1, v - 1, 0), x.push((e * i + d) / 2, v / 2), c.push(e * i + i + d - 1, v - 1, 0), x.push((e * i + i + d) / 2, v / 2), c.push(e * i + i / 2 + d - 1, s + v - 1, 0), x.push((e * i + i / 2 + d) / 2, (s + v) / 2), f = w((e + 1) / a, r / a) + Math.random();
                            const R = y(v / 2 + 2 * f / t);
    ...
    setProgress(e, t, n, o) {
        ...
        const i = this.textures[t],
            s = this.textures[e];
        this.material.uniforms.texture1.value = s, this.shader.vertex ? this.vertexMaterial.uniforms.texture1.value = i : this.material.uniforms.texture2.value = i, o ? (0 === n && 0 === this.material.uniforms.progress.value && (this.material.uniforms.progress.value = 1), 1 === n && 1 === this.material.uniforms.progress.value && (this.material.uniforms.progress.value = 0), this.animateUniform(this.material.uniforms.progress, n, (() => {
...
const Y = new d(".swiper", {
        modules: [u, function({
            ...
            t("beforeInit", (() => {
                ...
                if ("gl" !== e.params.effect || o || e.glDestroyed) return;
                let t, n, a;
                e.gl || i(), e.slides.forEach(((o, i) => {
                    const s = o.progress;
                    (s > 0 && s < 1 || 0 === s && e.progress < r) && (t = i, n = i + 1, a = s), (s < 0 && s > -1 || 0 === s && e.progress > r) && (t = i - 1, n = i, a = 1 + s)
                })), r = e.progress || 0, void 0 === t && void 0 === n || e.gl.setProgress(t, n, a, s)
            })), t("setTransition", ((t, n) => {
                "gl" !== e.params.effect || o || e.glDestroyed || (s = n > 0 && !e.params.cssMode)
            })), t("slidesGridLengthChange", (() => {
                "gl" !== e.params.effect || o || !e.initialized || e.glDestroyed || e.gl && e.gl.loadTextures && e.gl.loadTextures()
            })), t("beforeDestroy", (() => {
                "gl" !== e.params.effect || o || e.gl && (e.glDestroyed = !0, e.gl.destroy(), e.gl = null)
            }))
        }],
        speed: 1e3,
        effect: "gl",
...
document.querySelector(".demo-shader-selector").addEventListener("click", (() => {
    ...
    var t;
    "SPAN" === e.target.nodeName && (t = e.target.textContent.trim(), document.querySelector(".demo-shader-current").textContent =
     t, Y.gl.replaceShader(t), T.style.display = "none")
